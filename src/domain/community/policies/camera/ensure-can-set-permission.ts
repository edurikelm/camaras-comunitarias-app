 ...
 *   - CommunityAuthorizationError("Only an ACTIVE member of the community can set camera permissions")
 ...
 *   - CommunityAuthorizationError("Only the camera owner can set permissions")
 */
